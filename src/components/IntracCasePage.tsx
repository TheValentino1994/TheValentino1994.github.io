    ...
    <div style={{ background: T.bg, minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <Section>
        <p style={{ fontFamily: "'Inter',sans-serif", fontWeight: 400, fontSize: '24px', lineHeight: '36px', color: T.text, margin: 0 }}>
          A web platform for teams running classes, bookings, enrolments, payments, staff, customers, and communication from one connected system.
        </p>
      </Section>
      ...
      <Section>
        ...
        <div style={{ width: '580px', display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '40px' }}>
          ...
          <p style={BODY18}>The challenge was to bring these workflows into one clear web platform that could support daily operations without feeling heavy or difficult to use.</p>
        </div>
      ...
      <Section>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', maxWidth: '640px' }}>
            <p style={BODY18}>The goal was to design a web platform that could bring everyday business operations into one connected system — from scheduling and enrolments to payments, customer records, staff workflows, and communication.</p>
            <p style={BODY18}>The platform had to reduce manual work for admins, make daily tasks easier for coaches and staff, and give the business a clearer way to manage operations as it scaled.</p>
          </div>
      ...
      <Section>
        <Label>My Role</Label>
        <p style={H2D}>Designing the product from workflows to working interface</p>
        <div style={{ width: '580px', display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '40px' }}>
          <p style={BODY18}>Shaping the platform from early workflow requirements into a structured web interface for admins, coaches, staff, and customers.</p>
          <p style={BODY18}>My work covered user flows, core platform screens, admin panels, calendar-based views, UI components, and review iterations with the client to make sure the product supported real daily operations.</p>
        </div>
        <div style={{ display: 'flex', gap: '16px' }}>
          <GradCard num="01" title="Workflow structure" desc="Defined how scheduling, enrolments, payments, and staff workflows should connect inside." index={0} />
          <GradCard num="02" title="Platform UI" desc="Designed the main web interface, admin panels, tables, forms, and calendar-based views." index={1} />
          <GradCard num="03" title="Client iterations" desc="Reviewed screens with the client and adjusted flows based on operational needs." index={2} />
          <GradCard num="04" title="UI components" desc="Created reusable patterns for forms, tables, cards, filters, buttons, and status states." index={3} />
        </div>
      </Section>

      {/* FINAL PLATFORM EXPERIENCE */}
      <Section>
        <Label>Final Platform Experience</Label>
        <p style={H2D}>A web platform built for busy daily operations</p>
        <div style={{ width: '580px', display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '40px' }}>
          <p style={BODY18}>The final interface brings scheduling, enrolments, customer records, payments, staff workflows, and reporting into a structured web experience for teams managing activity-based businesses.</p>
          <p style={BODY18}>The focus was to make operational screens clear, scannable, and practical for everyday use — especially for admins and staff who need to move quickly between tasks.</p>
        </div>
...
function IntracCasePageMobile({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div style={{ background: T.bg, minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* ROLE */}
      <SectionMob>
        <p style={BODY_MOB}>A web platform for teams running classes, bookings, enrolments, payments, staff, customers, and communication from one connected system.</p>
      </SectionMob>
      ...
      <SectionMob>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', margin: '24px 0' }}>
          ...
          <p style={BODY_MOB_MUTED}>The challenge was to bring these workflows into one clear web platform that could support daily operations without feeling heavy or difficult to use.</p>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          {[
      ...
      <SectionMob>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', margin: '24px 0' }}>
          <p style={BODY_MOB_MUTED}>The goal was to design a web platform that could bring everyday business operations into one connected system — from scheduling and enrolments to payments, customer records, staff workflows, and communication.</p>
          <p style={BODY_MOB_MUTED}>The platform had to reduce manual work for admins, make daily tasks easier for coaches and staff, and give the business a clearer way to manage operations as it scaled.</p>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <DecisionRow num="01" title="Schedule"   desc="Plan classes, time slots, coaches, and locations." />
          <DecisionRow num="02" title="Enrolments" desc="Manage sign-ups, renewals, and class changes." />
      ...
      <SectionMob>
        ...
        <H2Mob>Designing the product from workflows to working interface</H2Mob>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', margin: '24px 0' }}>
          <p style={BODY_MOB_MUTED}>Shaping the platform from early workflow requirements into a structured web interface for admins, coaches, staff, and customers.</p>
          <p style={BODY_MOB_MUTED}>My work covered user flows, core platform screens, admin panels, calendar-based views, UI components, and review iterations with the client to make sure the product supported real daily operations.</p>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          {[
            { num: '01', title: 'Workflow structure', desc: 'Defined how scheduling, enrolments, payments, and staff workflows should connect inside.' },
            { num: '02', title: 'Platform UI', desc: 'Designed the main web interface, admin panels, tables, forms, and calendar-based views.' },
            { num: '03', title: 'Client iterations', desc: 'Reviewed screens with the client and adjusted flows based on operational needs.' },
            { num: '04', title: 'UI components', desc: 'Created reusable patterns for forms, tables, cards, filters, buttons, and status states.' },
          ].map(({ num, title, desc }) => (
            <div key={num} style={{ background: GRAD, borderRadius: '16px', padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <p style={{ fontFamily: "'Inter',sans-serif", fontWeight: 600, fontSize: '28px', lineHeight: '28px', letterSpacing: '-0.5px', color: T.text, margin: 0 }}>{num}</p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
      ...
      {/* FINAL PLATFORM EXPERIENCE */}
      <SectionMob>
        <div style={{ marginBottom: '12px' }}><Label>Final Platform Experience</Label></div>
        <H2Mob>A web platform built for busy daily operations</H2Mob>
        <p style={{ ...BODY_MOB_MUTED, margin: '24px 0' }}>The final interface brings scheduling, enrolments, customer records, payments, staff workflows, and reporting into a structured web experience for teams managing activity-based businesses.</p>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          {[
